...
val languages = listOf(
        Language(title = "Kotlin", iconAlt = "Kotlin Logo", iconLink = "kotlin.svg", body = """
        ...
        Language(title = "Java", iconAlt = "Java steaming mug logo", iconLink = "java.svg",
                 body = """
        ...
        Language(title = "C# .NET Core", iconAlt = "C-Sharp Icon", iconLink = "c-sharp-c.svg",
                 body = """
        ...
        Language(title = "TypeScript", iconAlt = "TypeScript TS Icon", iconLink = "ts.svg",
                 body = """
        ...
        Language(title = "JavaScript", iconAlt = "JavaScript JS Icon", iconLink = "js.svg",
                 body = """
                        <em>The</em>
        ...
        Language(title = "HTML 5", iconAlt = "HTML 5 Shield Icon", iconLink = "html5.svg",
                 body = """
        ...
        Language(title = "CSS 3", iconAlt = "CSS 3 Shield Icon", iconLink = "css3.svg", body = """
