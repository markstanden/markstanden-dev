...
val java =
    Language(title = "Java", iconAlt = "Java steaming mug logo", iconLink = "/static/images/icons/java.svg", body = """
...
val ts =
    Language(title = "TypeScript", iconAlt = "TypeScript TS Icon", iconLink = "/static/images/icons/ts.svg", body = """
...
val js =
    Language(title = "JavaScript", iconAlt = "JavaScript JS Icon", iconLink = "/static/images/icons/js.svg", body = """
                        <em>The</em>
...
val html =
    Language(title = "HTML 5", iconAlt = "HTML 5 Shield Icon", iconLink = "/static/images/icons/html5.svg", body = """
...
val languages = listOf(kotlin, java, cSharp, ts, js, css, html)